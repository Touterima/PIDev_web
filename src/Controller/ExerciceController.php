...
class ExerciceController extends AbstractController
{
    ...
    #[Route('/categorie/{categorieId}', name: 'app_categorie_exercice_show')]
    public function showCategorie(ExerciceRepository $exerciceRepository, $categorieId): Response
    {
        $exercises = $exerciceRepository->findBy(['categorie' => $categorieId]);
    ...
    #[Route('/{exerciceId}', name: 'app_exercice_show', methods: ['GET'])]
    ...
    #[Route('/{exerciceId}/edit', name: 'app_exercice_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{exerciceId}', name: 'app_exercice_delete', methods: ['POST'])]
